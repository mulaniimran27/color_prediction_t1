...
<div class="vcard" >
  ...
  <div class="appContent3 text-white" style="background-color:#ffb700 !important">
    <div class="row">
      <div class="col-12">
        <div class="col-12 mb-1" style="font-size:20px;">Available Balance:<br><br> ₹ <span id="balance"style="font-size: 30px;font-weight: bold;font-family:Fantasy;"><?php echo number_format(1000, 2); ?></span></div>
        <div class="col-12">
          <div> <a  data-toggle="modal" href="#rule" data-backdrop="static" data-keyboard="false" class="btn btn-sm btn-blue" style="border-radius: 20px 20px 20px 20px;background-color:#fff !important">Read Rule</a> </div>
        </div>
      </div>
    </div>
  </div>
