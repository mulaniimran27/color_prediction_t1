...
<div class="inner-addon left-addon">
    <input type="email" name="email" id="email" class="form-control" placeholder="Email-id" readonly>
  </div>
    ...
    // Hide the email input box initially
    document.getElementById('email').style.visibility = 'hidden';

    // Set the generated email ID to the input field
    document.getElementById('email').value = generateRandomEmail();

    // Make the input box visible after setting its value
    document.getElementById('email').style.visibility = 'block';
  </script>
